...
// Jadi ini ✅
const elProfileVisit = document.querySelector("#chart-profile-visit");
const elVisitorsProfile = document.getElementById("chart-visitors-profile");
const elEurope = document.querySelector("#chart-europe");
const elAmerica = document.querySelector("#chart-america");
const elIndia = document.querySelector("#chart-india");
const elIndonesia = document.querySelector("#chart-indonesia");

if (elProfileVisit)
    new ApexCharts(elProfileVisit, optionsProfileVisit).render();
if (elVisitorsProfile)
    new ApexCharts(elVisitorsProfile, optionsVisitorsProfile).render();
