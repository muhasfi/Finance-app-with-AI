    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <h4 class="logo">
                    <a href="{{ url('dashboard') }}">Finance APP</a>
                </h4>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ request()->routeIs('transfer.*') ? 'active' : '' }}">
                    <a href="{{ route('transfer.create') }}" class="sidebar-link">
                ...
                <li class="sidebar-item {{ request()->routeIs('recurring.*') ? 'active' : '' }}">
                    <a href="{{ route('recurring.index') }}" class="sidebar-link">
                ...
                <li class="sidebar-item {{ request()->routeIs('import.*') ? 'active' : '' }}">
                    <a href="{{ route('import.create') }}" class="sidebar-link">
